...
# python srl_pruning.py --train --train_data data/conll09-english/conll09_train.dataset --valid_data data/conll09-english/conll09_dev.dataset --test_data data/conll09-english/conll09_test.dataset --ood_data data/conll09-english/conll09_test_ood.dataset --K 10 --seed 100 --tmp_path temp --model_path model --result_path result \
...
# python srl_pruning.py --eval --train_data data/conll09-english/conll09_train.dataset --valid_data data/conll09-english/conll09_dev.dataset --test_data data/conll09-english/conll09_test.dataset --ood_data data/conll09-english/conll09_test_ood.dataset --K 10 --seed 100 --tmp_path temp --model_path model --result_path result \
# --pretrain_embedding pretrain/glove.6B.100d.txt --pretrain_emb_size 100  --epochs 20 --dropout 0.1 --lr 0.001 --batch_size 64 --word_emb_size 100 --pos_emb_size 32 --lemma_emb_size 100 --use_deprel --deprel_emb_size 64 \
# --bilstm_hidden_size 512 --bilstm_num_layers 4 --valid_step 1000 --use_highway --highway_num_layers 10 --use_flag_emb --flag_emb_size 16 --use_elmo --elmo_emb_size 300 --elmo_options pretrain/elmo_2x4096_512_2048cnn_2xhighway_options.json --elmo_weight pretrain/elmo_2x4096_512_2048cnn_2xhighway_weights.hdf5
...
if __name__ == '__main__':
    ...
    if FLAG == 'TRAIN':
        ...
        for epoch in range(max_epoch):
            ...
            for batch_i, train_input_data in enumerate(inter_utils.get_batch(train_dataset, batch_size,word2idx,
                ...
                if batch_i > 0 and batch_i % show_steps == 0: 
                    ...
                    print('dev:')
                    score, dev_output = pruning_eval_data(srl_model, elmo, dev_dataset, batch_size, dev_out_of_pruning, word2idx, lemma2idx, pos2idx, pretrain2idx, deprel2idx, argument2idx, idx2argument, unify_pred, dev_predicate_correct, dev_predicate_sum)
                    if dev_best_score is None or score[2] > dev_best_score[2]:
                        dev_best_score = score
                        torch.save(srl_model, os.path.join(args.model_path,'best_{:.2f}.pkl'.format(dev_best_score[2]*100)))
        ...
        srl_model.eval()
        print('test:')
        score, test_output = pruning_eval_data(srl_model, elmo, test_dataset, batch_size, test_out_of_pruning, word2idx, lemma2idx, pos2idx, pretrain2idx, deprel2idx, argument2idx, idx2argument, unify_pred, test_predicate_correct, test_predicate_sum)
